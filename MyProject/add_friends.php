...
<head>
  ...
  <title> Friends Insert </title>

</head>

<body>
  <h1 id="MainTitle01"> Add Friends </h1>
  <hr id="hr01">

  <div class="form">
    <form style="margin-left: 10px;" action="backend_files/friends_input.php" method="post">

      <label> User Name: </label>
      <select id="option" name="u_name">
        <?php
        include_once("backend_files/db_connection.php");
        $sql1 = "select user_name FROM `user_info`";
